...
CONTENT_FILES = [
    ...
    "western_astrology/birthstones.json",
    "western_astrology/aspects.json",
    "western_astrology/retrogrades.json",
    "western_astrology/transiting_planets.json",
    "western_astrology/lilith.json",
    "western_astrology/chiron.json",
    "western_astrology/asteroids.json",
    ...
    "numerology/karmic_debt.json",
    "vedic_astrology/nakshatras.json",
    "vedic_astrology/nodes.json",
    "vedic_astrology/dashas.json",
    "vedic_astrology/navamsa.json",
    "vedic_astrology/yogas.json",
    "feng_shui/kua_numbers.json",
    "feng_shui/bagua_zones.json",
    "feng_shui/five_elements.json",
    "tarot/major_arcana.json",
    "chinese_astrology/animal_signs.json",
    "chinese_astrology/elements.json",
